 ...
 * 
 * modifications by Raisa Litchfield
 */
...
void printusageexit(char *exe) {
	...
	fprintf(stderr, "usage: %s ninserts nlookups ptable> commandfilename\n", exe);
    ...
    fprintf(stderr, " ptable: p = print table, or - = don't print table\n");
